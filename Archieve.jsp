...
<div class="body">
  <div class="search">
    <input style="margin-left: 75%;" id="myInput" type="search" class="search-table-filter" data-table="js-sort-table" placeholder=" Search.."><i class="fa fa-fw fa-search"></i>
  </div>
...
%>
        ...
        <div class="productchoose">
          ...
          <div class="addnav">
            ...
            <button type="submit" class="addorder" formaction="/IMS/CONTROLLER/Add_Product.jsp"><i class="fa fa-check-circle" aria-hidden="true"></i>&nbsp;&nbsp;Save Changes</button>
          </div>
        </div> 
      </div>
      </form>
...
List<Variable_Product> list = obj_Get_Value.Archive();
...
%>	
	...
	<tr>
        ...
        <td><a class="view" href="/IMS/INVENTORY/Archive1.jsp?name=<%=obj_Variable_Product.getName() %>">Retrieve</a></td>
